...
public class ByteGeneratorTest
{
    ...
    private readonly IValueGenerator _doubleGenerator = new ByteGenerator();
    private readonly GeneratorContext _context = new(new Random(), new FakerImpl());
    private readonly Type _type = typeof(byte);
    
    [Test, Retry(5)]
    public void GenerateTest()
    {
        var result1 = (byte)_doubleGenerator.Generate(_type, _context);
        var result2 = (byte)_doubleGenerator.Generate(_type, _context);
        var result3 = (byte)_doubleGenerator.Generate(_type, _context);
