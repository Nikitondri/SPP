...
public class LongGeneratorTest
{
    ...
    private readonly IValueGenerator _doubleGenerator = new LongGenerator();
    private readonly GeneratorContext _context = new(new Random(), new FakerImpl());
    private readonly Type _type = typeof(long);
    
    [Test, Retry(5)]
    public void GenerateTest()
    {
        var result1 = (long)_doubleGenerator.Generate(_type, _context);
        var result2 = (long)_doubleGenerator.Generate(_type, _context);
        var result3 = (long)_doubleGenerator.Generate(_type, _context);
